...
[M_LAYER] = LAYOUT_75_ansi(
    QK_REBOOT,  DB_TOGG,    RF_DFU,     _______,   _______,    _______,     _______,   _______,     _______,     _______,   _______,    _______,     _______,    _______,    _______,    _______,
    ...
    CAPS_WORD,  _______,    _______,    _______,   _______,    GAME_MODE,   _______,   _______,     _______,     _______,   _______,    _______,                             _______,    _______,
    _______,                _______,    _______,   _______,    _______,     _______,   NUMLOCK_IND, _______,     SIDE_SPD,  SIDE_SPI,   _______,                 _______,    SIDE_VAI,   _______,
    _______,    LGUI_TG,    _______,                                        _______,                             _______,   MO(4),      _______,                 SIDE_MOD,   SIDE_VAD,   SIDE_HUI)
