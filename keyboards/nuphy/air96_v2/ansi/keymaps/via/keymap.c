...
// layer 0 Mac
[0] = LAYOUT_96_ansi(
	KC_ESC, 	KC_BRID,  	KC_BRIU,  	KC_MCTL, 	MAC_SEARCH, MAC_VOICE,  MAC_DND,  	KC_MPRV,  	KC_MPLY,  	KC_MNXT, 	KC_MUTE, 	KC_VOLD, 	KC_VOLU, 	MAC_PRTA,	KC_DEL, 	KC_HOME,	KC_END,		KC_PGUP,	KC_PGDN,
...
// layer 1 Mac Fn
[1] = LAYOUT_96_ansi(
	_______, 	KC_F1,  	KC_F2,  	KC_F3, 		KC_F4,  	KC_F5,  	KC_F6,  	KC_F7,  	KC_F8,  	KC_F9, 		KC_F10, 	KC_F11, 	KC_F12, 	KC_PSCR,	KC_INS,		_______,	_______,	_______,	_______,
	...
	MO(4),				    _______,   	_______,   	RGB_TEST,  	_______,   	BAT_NUM,   	_______,	MO(4), 		RGB_SPD,	RGB_SPI,	_______,	MO(4),				    RGB_VAI,	_______,	_______,	_______,	_______,
